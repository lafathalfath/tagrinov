...
class FooterSeeder extends Seeder
{
    ...
    public function run(): void
    {
        FooterSetting::create([
            ...
            'fax' => '(0251) 8350928',
            'email' => 'bsip.bbpsip@pertanian.go.id',
            'address' => 'Jl. Tentara Pelajar No.10, RT.01/RW.07, Ciwaringin, Kecamatan Bogor Tengah, Kota Bogor, Jawa Barat 16124',
            'website_link' => 'https://bbpsip.bsip.pertanian.go.id',
            'facebook_link' => 'https://www.facebook.com/BSIPPenerapan/',
            'youtube_link' => 'https://www.youtube.com/@bsippenerapan',
            'instagram_link' => 'https://instagram.com/bsippenerapan',
            'twitter_link' => 'https://twitter.com/bsippenerapan',
            'tiktok_link' => 'https://tiktok.com/@bsippenerapan',
        ]);
    }
}
