    ...
    <div class="container">
        ...
        <div class="seed-grid" id="seed-grid">
            <div class="seed-item" data-name="Benih Kangkung">
                <a href="{{ route('benih.show', 'benih-kangkung') }}"><img src="{{ asset('images/seed1.png') }}" alt="Benih Kangkung">
                <p>Benih Kangkung</p></a>
            </div>
            <div class="seed-item" data-name="Benih Bawang Merah">
                <a href="{{ route('benih.show', 'benih-kangkung') }}"><img src="{{ asset('images/seed2.png') }}" alt="Benih Bawang Merah">
